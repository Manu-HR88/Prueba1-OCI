...
numero_archivos = st.slider("Selecciona la cantidad de archivos a subir", 1, 20, 1)
...
if not df_resultados_total.empty:
    ...
    df_analisis = pd.DataFrame({
        "Reactivo": [f'P{i}' for i in range(1, 61)],
    ...
    st.write(df_analisis.style.applymap(highlight_error, subset=['Porcentaje de Error']))
